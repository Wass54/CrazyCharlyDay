        ...
        <html lang="en">
            ...
            <body>
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <li><a class="dropdown-item" href="#!">Les nouveaux produits</a></li>
                                    </ul>
                                </li>
                            </ul>
                            <form class="d-flex">
                ...
                <header class="bg-dark py-5">
                    <div class="container px-4 px-lg-5 my-5">
                        <div class="text-center text-white">
                            <h1 class="display-4 fw-bolder">Nos box ont du style</h1>
                            <p class="lead fw-normal text-white-50 mb-0">Beauté, Bijoux, Décoration, Produit ménager, Upcycling</p>
                        </div>
                    </div>
                </header>
                <!-- Section-->
                ...
                <footer class="py-5 bg-dark">
                    <div class="container"><p class="m-0 text-center text-white">Copyright : Karakaya, Orzechowski, Marzouk, Malleret, El Bakhtaoui</p></div>
                </footer>
                <!-- Bootstrap core JS-->
