...
class HTML_Creator{
    ...
    public function html_body(string $content): string{
        ...
        $url_categorie = $this->container->router->pathFor('categorie');
                ...
                <div class="container px-4 px-lg-5">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                            <li class="nav-item"><a class="nav-link active" aria-current="page" href="$url_produit">Produit</a></li>
                            <li class="nav-item"><a class="nav-link active" aria-current="page" href="$url_categorie">Catégories</a></li>
